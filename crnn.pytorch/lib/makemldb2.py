...
def create_dataset(output_path, images_path, dataset_file_path, check_valid=True):
    ...
    env = lmdb.open(output_path, map_size=10995116)  # map_size=20G
    cache = {}
    cnt = 1
    bad_cnt = 0
...
if __name__ == '__main__':
    output_path = './lib/SyntheticChineseStringDataset/test'
    images_path = PREFIX = './lib/SyntheticChineseStringDataset/images'
    dataset_file_path = './lib/SyntheticChineseStringDataset/test/test.txt'
